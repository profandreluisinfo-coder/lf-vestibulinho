...
@section('title', 'Área Administrativa — Vestibulinho {{ $calendar?->year }}')
...
@section('left-panel')
    ...
    <div class="panel-center">
        ...
        <p class="lead-text">
            Gerencie o site, notícias, comunicados, inscrições, acompanhe indicadores, publique editais e organize
            convocações — o controle total do processo em um só lugar.
        </p>
...
@section('right-panel')
    ...
    <div class="form-card">
        ...
        <div class="form-top">
            ...
            <!-- Título -->
            <h1>EM Dr Leandro Franceschini</h1>
            ...
            <div>
                ...
                <div class="field-wrap">
                    <input type="password" id="loginPassword" name="password"
                        ...
                        style="padding-right:2.8rem;" autocomplete="current-password" oninput="clearError(this)" />
