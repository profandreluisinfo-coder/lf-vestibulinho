...
@section('left-panel')
    ...
    <div class="panel-center">
        ...
        <p class="lead-text">
            Gerencie o site, notícias, comunicados, inscrições, acompanhe indicadores, publique editais e organize convocações — o controle total do processo em um só lugar.
        </p>
