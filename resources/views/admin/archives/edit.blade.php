...
@section('page-title', config('app.name') . ' ' . $selection_process->year . ' | Editar Arquivo de Prova')
...
@push('scripts')
    <script src="{{ asset('assets/js/vestibulinho/rules/archives/edit.js') }}"></script>
@endpush