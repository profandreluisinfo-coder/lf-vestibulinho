    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <table class="table-striped table caption-top">
                <caption>Vestibulinho LF  {{ $process?->year }} - Lista de Locais de Prova</caption>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    <form id="delete-location-form-{{ $local->id }}"
                                        action="{{ route('admin.local.destroy', $local->id) }}" method="POST"
                                        style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                    ...
                    <div class="modal-body">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <form id="exam-location" action="{{ route('admin.local.store') }}" method="POST" novalidate>
                                    @csrf
