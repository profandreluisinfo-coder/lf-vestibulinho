    ...
    <div class="container">
                    ...
                    <div class="card shadow h-100" style="background-color: #ffffe6">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-0">
                                <li class="mb-2">
                                    <a href="{{ route('admin.exam.index') }}" class="text-decoration-none">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2">
                                        <a href="{{ route('admin.allocations.allocation') }}" target="_blank"
                                            class="text-decoration-none">
                                            <i class="bi bi-file-earmark-pdf-fill me-2"></i>Simples Conferência (PDF)
                                        </a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('admin.allocations.rooms') }}" target="_blank"
                                            class="text-decoration-none">
                                            <i class="bi bi-file-earmark-pdf-fill me-2"></i>Mural e Salas (PDF)
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.allocations.signs') }}" target="_blank"
                                            class="text-decoration-none">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="card shadow h-100" style="background-color: #ffffe6">
                        <div class="card-body">
                            ...
                            <form id="location-access-form" action="{{ route('admin.system.publish.location') }}"
                                method="POST">
                                @csrf

                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="location" name="location"
                                        onchange="confirmLocationAccess(this)"
                                        {{ $accesStatus->location ? 'checked' : '' }}>
        ...
        <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
            ...
            <table class="table table-striped freezed-table mb-0 caption-top">
                <caption>{{ config('app.name') }} {{ $process?->year }} - Lista de Alocação de Candidatos</caption>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="exam-schedule" method="POST" action="{{ route('admin.exam.store') }}">
                            @csrf
