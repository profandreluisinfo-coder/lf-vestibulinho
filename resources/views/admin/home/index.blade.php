...
@section('content')
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('admin.calendar.show') }}" class="btn btn-primary btn-sm w-100">
                            Gerenciar
                        </a>
                    </div>
                </div>
    ...
    <div class="accordion accordion-flush shadow-lg mb-5" id="accordionFlushOne">
            ...
            <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne">
                ...
                <div class="accordion-body">
                    <div class="stepper-container mb-5">
                        ...
                        <!-- Etapa 1 -->
                        <a href="{{ route('admin.calendar.show') }}" class="step-item text-secondary text-center"
