                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="publish-notice-form-{{ $settings->id }}"
                                        action="{{ route('admin.system.publish.notice') }}" method="POST" class="d-none">
                                        @csrf
                                        @method('PUT')
                                    </form>
                    ...
                    <div class="modal-body">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <form id="form-file" action="{{ route('admin.notices.store') }}" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <form id="form-file" action="{{ route('admin.notices.update') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
...
@push('scripts')
    <script src="{{ asset('assets/js/vestibulinho/rules/notice/index.js') }}"></script>
    <script src="{{ asset('assets/js/vestibulinho/swa/notice/delete.js') }}"></script>
    <script src="{{ asset('assets/js/vestibulinho/swa/notice/publish.js') }}"></script>
    <script>
