        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form id="form-calendar" action="{{ route('admin.calendar.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="border-start border-primary border-4 ps-3 mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('reference') is-invalid @enderror"
                                        id="reference" name="reference" min="2027"
                                        value="{{ old('reference', $calendar->reference ?? '') }}">
                                    @error('reference')
                        ...
                        <div class="d-flex gap-2 mt-4 pt-3 border-top">
                            ...
                            <a href="{{ route('admin.calendar.show') }}" class="btn btn-secondary btn-sm">
...
@push('scripts')
    <script src="{{ asset('assets/js/vestibulinho/rules/calendar/edit.js') }}"></script>
@endpush