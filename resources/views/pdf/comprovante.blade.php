    ...
    <div class="card-body">
      ...
      <div class="no-break">
        ...
        <table>
          ...
          <tbody>
            <tr><th>Mãe:</th><td>{{ $user->user_detail->mother }}@if($user->user_detail->mother_phone) | Telefone: {{ $user->user_detail->mother_phone }}@endif</td></tr>
            @if ($user->user_detail->father)
              <tr><th>Pai:</th><td>{{ $user->user_detail->father }}@if($user->user_detail->father_phone) | Telefone: {{ $user->user_detail->father_phone }}@endif</td></tr>
            @endif
            @if ($user->user_detail->responsible)
              <tr><th>Responsável legal:</th><td>{{ $user->user_detail->responsible }}</td></tr>
              <tr><th>Parentesco:</th><td>{{ $user->user_detail->degree }}@if($user->user_detail->kinship) ({{ $user->user_detail->kinship }})@endif | Telefone: {{ $user->user_detail->responsible_phone }}</td></tr>
            @endif
