...
@push('metas')
  ...
  <meta name="description"
    content="Verificação de e-mail para candidatos do {{ config('app.name') }} {{ config('app.year') }}">
@endpush

@section('page-title', config('app.name') . ' ' . config('app.year') . ' | Verificação de E-mail')
