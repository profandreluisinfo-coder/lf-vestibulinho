    ...
    <div class="wrapper">
        ...
        <div class="alerts-container animate__animated animate__fadeInUp mb-4">
            ...
            <div class="card-modern animate__animated animate__fadeIn">
                ...
                <div class="data-grid">
                    <div class="data-item">
                        <div class="data-label">Inscrição</div>
                        <div class="data-value">#{{ $user->inscription->id }}</div>
                    </div>
                    ...
                    <div class="data-item">
                        ...
                        <div class="data-value">{{ $user->cpf }}</div>
                    </div>
                        ...
                        <div class="info-block-row">
                            <div>
                                ...
                                @if ($user?->lgbt?->authorization)
                                    <a class="file-link" href="{{ asset('storage/' . $user?->lgbt?->authorization) }}"
                                        target="_blank">
                    ...
                    <div class="info-block">
                        ...
                        <div class="info-block-row">
                            <div>
                                ...
                                @if ($user?->pne?->report)
                                    <a class="file-link" href="{{ asset('storage/' . $user->pne?->report) }}"
                                        target="_blank">
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>Seu documento de identidade foi expedido há mais de 5 anos
                                        ...
                                        realização da prova será
                                        <strong>obrigatória</strong> a apresentação de documento oficial de identificação
                                        com fotografia atual. Caso o documento informado não possua fotografia que permita
                                        sua
                                        adequada identificação, providencie um novo documento antes da data da prova.
                                    </li>
                            ...
                            <div style="font-size:0.95rem; font-weight:600;">
                                ...
                                <div class="call-data-grid"
                                    ...
                                    <div class="call-data-item" style="border-color:#bee3f8; background:#ebf8ff;">
                                        ...
                                        <div class="call-data-value" style="color:#1a365d;">{{ $exam->room_number }}
                                        </div>
                                    </div>
                                    <div class="call-data-item" style="border-color:#bee3f8; background:#ebf8ff;">
                            ...
                            <div class="modal-body p-3">
                                <div class="result-card-modern">
                                    ...
                                    <div class="result-card-header">
                                        ...
                                        <span class="badge bg-light text-primary">Ano {{ $process?->year }}</span>
                                    </div>
                        ...
                        <div class="modal-content" style="border-radius:12px; border:1px solid #fcd34d;">
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="alert alert-warning py-2 px-3 mb-2"
                                    ...
                                    <i class="bi bi-exclamation-triangle-fill me-1"></i>
                                    A falta de documentação ou o não comparecimento resultará na <strong>perda da
                                        vaga</strong>.
                                </div>
                                <ol class="docs-list-modern">
                                    <li>Declaração de Conclusão do Ensino Fundamental ou Histórico Escolar (original + 1
                                        cópia)
                                    </li>
                                    <li>1 foto 3×4</li>
                                    <li>Documento de identidade com foto — RG/CIN ou RNE para estrangeiros (original + 1
                                        cópia)
                                    </li>
