...
@section('content')
    ...
    <form id="inscription" class="row g-4 inscription-form" action="{{ route('inscription.step.address') }}" method="POST">
        @csrf
        ...
        <div class="form-group col-md-4">
            <label for="cep" class="form-label required">CEP</label> <a
                ...
                title="Consulte seu CEP através do Correios" tabindex="-1" target="_blank" style="font-size: 12px;">Não
                sabe seu CEP?</a>
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control @error('home') is-invalid @enderror" id="home" name="home"
                value="{{ old('home', session('step3.home')) }}">
            @error('home')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
