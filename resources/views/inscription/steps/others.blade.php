...
@section('content')
    ...
    <div class="wrapper">
        ...
        <form id="inscription" class="row g-4" action="{{ route('inscription.step.other') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6 {{ $selectedHealth == 1 ? '' : 'd-none' }}">
                ...
                <small id="msgHealthIssues" class="text-muted fst-italic"><i class="bi bi-info-circle"></i> Clique para escolher um item da lista ou descreva.</small>
            ...
            <div class="form-group col-md-6 mt-3 {{ $selectedPne == 1 ? '' : 'd-none' }}">
                ...
                <small id="msgDisabilities" class="text-muted fst-italic"><i class="bi bi-info-circle"></i> Clique para escolher um item da lista  ou descreva.</small>
            ...
            <div class="form-group col-md-12" {{ $selectedPne == 1 ? '' : 'd-none' }}>
                ...
                <div class="alert alert-warning d-flex align-items-center" role="alert">
                    ...
                    <div>
                        O(A) candidato(a) que, no ato da inscrição, declarar possuir necessidades especiais deverá apresentar laudo ou relatório de avaliação médica que ateste a natureza e o grau da condição informada, bem como a compatibilidade com as medidas de acessibilidade solicitadas. O documento deverá ser anexado obrigatoriamente ao formulário de inscrição, sob pena de indeferimento do pedido.
                    </div>
                </div>
                ...
                <small id="infoPneReport" class="form-text fst-italic text-muted"><i
                        class="bi bi-info-circle me-1"></i>Somente arquivos no formato PDF são aceitos. O tamanho máximo é de 5MB.</small>
            ...
            <div class="form-group col-md-12 mt-3 {{ $selectedPne == 1 ? '' : 'd-none' }}">
                ...
                <input list="accessibilityResources" class="form-control @error('pne_description') is-invalid @enderror"
                    ...
                    value="{{ old('pne_description', session('step6.pne_description')) }}"
            ...
            <div class="form-group col-md-6 mt-3 mb-3 {{ $selectedProgram == 1 ? '' : 'd-none' }}">
                ...
                <input type="text" class="form-control @error('nis') is-invalid @enderror" id="nis"
                    name="nis" value="{{ old('nis', session('step6.nis')) }}">
                @error('nis')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
