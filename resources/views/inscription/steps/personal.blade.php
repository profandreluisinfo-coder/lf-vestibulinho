    ...
    <form id="inscription" class="row g-4" action="{{ route('inscription.step.personal') }}" method="POST"
        ...
        <div class="form-group col-md-3">
            ...
            <select class="form-select @error('nationality') is-invalid @enderror" id="nationality" name="nationality">
                ...
                <option value="4" {{ $selectedNationality == 4 ? 'selected' : '' }}>Portuguesa (com estatuto de
                    igualdade)</option>
            </select>
        ...
        <div class="form-group col-md-3">
            ...
            <select class="form-select @error('doc_type') is-invalid @enderror" id="doc_type" name="doc_type">
                ...
                <option value="2" {{ $selectedDocType == 2 ? 'selected' : '' }}>CIN - Carteira de Identidade Nacional
                </option>
                <option value="3" {{ $selectedDocType == 3 ? 'selected' : '' }}>RNM - Registro Nacional Migratório
                </option>
            </select>
        </div>
        <div class="form-group col-md-3">
