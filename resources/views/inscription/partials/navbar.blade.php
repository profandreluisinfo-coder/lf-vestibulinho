<nav class="navbar navbar-expand-lg navbar-custom fixed-top" id="mainNav">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center gap-2" href="javascript:void(0);">
            <div
                style="width:38px;height:38px;border-radius:10px;background:var(--grad-teal);
            ...
            <div>
                ...
                <span class="sub text-white">Vestibulinho {{ $process?->year }}</span>
            </div>
        </a>

        {{-- ── Toggle mobile ──────────────────────────────────── --}}
        <button class="navbar-toggler border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navMenuDash"
            aria-controls="navMenuDash" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        <li>
                            <div style="padding:.6rem .85rem .5rem;border-bottom:1px solid var(--color-light-mid);">
                                <p
                                    style="font-size:.72rem;font-weight:700;color:var(--color-muted);
                                              text-transform:uppercase;letter-spacing:.07em;margin:0 0 .15rem;">
                                    Logado como
                                </p>
                                <p
                                    style="font-size:.84rem;font-weight:700;color:var(--color-navy);
