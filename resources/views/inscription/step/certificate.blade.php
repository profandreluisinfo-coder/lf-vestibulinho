...
@section('content')
    ...
    <div class="wrapper">
        ...
        <form id="inscription" class="row m-0 g-4" action="{{ route('inscription.step.certificate') }}" method="POST">
            @csrf
        ...
        <div class="modal fade" id="oldCertificateModal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="{{ asset('assets/img/certidao-nascimento-antiga.webp') }}" class="img-fluid"
                            width="800" alt="Certidão de Nascimento Modelo Antigo">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Fechar</button>
                    </div>
