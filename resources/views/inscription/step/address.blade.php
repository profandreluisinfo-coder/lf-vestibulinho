...
@section('content')
    ...
    <div class="wrapper">
        ...
        <form id="inscription" class="row g-4" action="{{ route('inscription.step.address') }}" method="POST">
            @csrf
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('street') is-invalid @enderror" id="street"
                    name="street" value="{{ old('street', session('step3.street')) }}">
                @error('street')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control @error('number') is-invalid @enderror" id="number"
                    name="number" value="{{ old('number', session('step3.number')) }}">
                @error('number')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control @error('burgh') is-invalid @enderror" id="burgh"
                    name="burgh" value="{{ old('burgh', session('step3.burgh')) }}">
                @error('burgh')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-select form-select-md @error('state') is-invalid @enderror" id="state"
                    name="state">
                    ...
                    <option value="MS" {{ session('step3.state') == 'MS' ? 'selected' : '' }}>Mato Grosso do Sul
                    </option>
                    ...
                    <option value="RN" {{ session('step3.state') == 'RN' ? 'selected' : '' }}>Rio Grande do Norte
                    </option>
                    <option value="RS" {{ session('step3.state') == 'RS' ? 'selected' : '' }}>Rio Grande do Sul
                    </option>
            ...
            <div class="col-12 border-top pt-3">
                <button type="button" class="btn btn-sm btn-secondary">
                    ...
                    <a href="{{ route('inscription.step.certificate') }}" class="text-decoration-none">Voltar</a>
                </button>
