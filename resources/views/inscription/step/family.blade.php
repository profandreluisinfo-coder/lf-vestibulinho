    ...
    <div class="wrapper">
        ...
        <form id="inscription" class="row g-4" action="{{ route('inscription.step.family') }}" method="POST">
            ...
            <div class="form-group col-sm-8">
                ...
                <input type="text" class="form-control @error('mother') is-invalid @enderror" id="mother"
                    name="mother" value="{{ old('mother', session('step5.mother')) }}">
                @error('mother')
            ...
            <div class="form-group col-sm-8">
                ...
                <input type="text" class="form-control @error('father') is-invalid @enderror" id="father"
                    name="father" value="{{ old('father', session('step5.father')) }}">
                @error('father')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group respLegal d-none" id="other_relationship">
                ...
                <input type="text" class="form-control @error('kinship') is-invalid @enderror" id="kinship"
                    name="kinship" value="{{ old('kinship', session('step5.kinship')) }}">
                @error('kinship')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="email" class="form-control @error('parents_email') is-invalid @enderror"
                    id="parents_email" name="parents_email"
                    value="{{ old('parents_email', session('step5.parents_email')) }}">
                @error('parents_email')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
