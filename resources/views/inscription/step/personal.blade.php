                ...
                <select class="form-select @error('nationality') is-invalid @enderror" id="nationality"
                    ...
                    @foreach ($nationalities as $nationality)
                        <option value="{{ $nationality->id }}"
                            {{ old('nationality', session('step1.nationality')) == $nationality->id ? 'selected' : '' }}>
                ...
                <select class="form-select @error('doc_type') is-invalid @enderror" id="doc_type" name="doc_type">
                    ...
                    @foreach ($documents as $document)
                        <option value="{{ $document->id }}"
                            {{ old('doc_type', session('step1.doc_type')) == $document->id ? 'selected' : '' }}>
                            {{ $document->type }} - {{ $document->description }}</option>
                    @endforeach
