@if ($calendar && $calendar?->inscription_start && $calendar?->inscription_end)
    {{-- @if (now()->between($calendar?->inscription_start, $calendar?->inscription_end)) --}}
    @if (now()->between($calendar?->inscription_start, \Carbon\Carbon::parse($calendar?->inscription_end)->endOfDay()))
                    ...
                    <div class="col-lg-8">
                        <div class="countdown-container" id="countdown" data-deadline="{{ $deadline }}">
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <a href="{{ route('register') }}" class="btn btn-success btn-lg px-4" title="Inscrever-se Agora">
