                ...
                <div class="col-lg-7">
                    <div class="hero-badge mb-3">
                        ...
                        @if ($show && $open)
                            Inscrições Abertas ·
                        @else
                            Inscrições (Aguardando Abertura) ·
                        @endif
                        100% Online · Gratuito
                    </div>
                    <h1 class="mb-3">
                        <em>Vestibulinho LF</em>
                        @if ($show && $open)
                            {{ ' ' . $calendar?->year }}
                            <br>
                        @endif
                    ...
                    <div class="hero-actions d-flex flex-wrap gap-3">
                        @if ($show && $open)
                            <a href="{{ route('guest.login') }}" class="btn-hero-primary">
            ...
            <div class="container">
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-lg-6 reveal delay-2 text-lg-end">
                        @if ($open)
                            <a href="{{ route('guest.login') }}" class="btn-faq-more">
                ...
                <div class="timeline-wrap">
                    ...
                    <div class="tl-item reveal-right">
                        ...
                        <div class="tl-content">
                            ...
                            <p>Acesse o <a href="{{ route('guest.register') }}" class="text-amber">formulário de registro</a>,
                    ...
                    <div class="tl-item reveal-left">
                        ...
                        <div class="tl-content">
                            ...
                            <p>Após confirmar seu e-mail, acesse a <a href="{{ route('guest.login') }}"
            ...
            <div class="container position-relative" style="z-index:1;">
                ...
                <div class="row g-4">
                    <div class="col-6 col-md-4 col-lg-2 reveal delay-1">
                        <a href="{{ $notice->status && $notice->file ? asset('storage/' . $notice->file) : '#' }}"
                            class="quick-card d-block" @if ($notice->status && $notice->file) target="_blank" @endif>
                    ...
                    <div class="col-6 col-md-4 col-lg-2 reveal delay-3">
                        <a href="{{ route('guest.login') }}" class="quick-card d-block">
                    ...
                    <div class="col-6 col-md-4 col-lg-2 reveal delay-4">
                        <a href="{{ route('guest.register') }}" class="quick-card d-block">
                ...
                <div class="reveal">
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <div class="pulse-wrap">
                            @if ($open)
                                <a href="{{ route('guest.login') }}" class="btn-cta-main">
