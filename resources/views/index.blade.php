...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .btn-nav-cta:hover {
            box-shadow: 0 4px 18px rgba(0, 168, 150, .45) !important;
        ...
        #candidato-cta .section-title {
            color: #fff;
        }

        #candidato-cta .section-lead {
            ...
            <div class="timeline-wrap">
                ...
                <div class="tl-item reveal-left">
                    ...
                    <div class="tl-content">
                        ...
                        <p>Acesse o edital completo na seção de documentos. Leia todas as regras, requisitos de
                ...
                <div class="tl-item reveal-right">
                    ...
                    <div class="tl-content">
                        ...
                        Preencha o <a href="{{ route('register') }}"
                ...
                <div class="tl-item reveal-left">
                    ...
                    <div class="tl-content">
                        ...
                        <p>Na <a href="{{ route('login') }}" class="text-decoration-none text-teal">Área do
                                Candidato</a>, preencha o formulário de inscrição com suas informações pessoais,
                            acadêmicas e demais dados solicitados. Confirme os dados e guarde o número de inscrição
                            gerado.</p>
                    </div>
                </div>
                <!-- Step 4 -->
                <div class="tl-item reveal-right">
                    ...
                    <div class="tl-content">
                        ...
                        <p>Acesse as provas anteriores disponíveis aqui no site para se preparar. A prova aborda
                            Português, Matemática e conhecimentos gerais.</p>
                    </div>
                </div>
                <!-- Step 5 -->
                <div class="tl-item reveal-left">
        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-lg-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="#" class="d-flex align-items-center justify-content-center"
                            ...
                            onmouseout="this.style.background='rgba(255,255,255,.07)'"><i
                ...
                <div class="col-6 col-lg-2 foot-col">
                    <h6>Contato</h6>
                    <ul class="list-unstyled d-flex flex-column gap-2">
                        <li><a href="#"><i class="bi bi-envelope me-1"></i><span style="font-size: 12px;">emdrleandrofranceschini@educacaosumare.com.br</span></a></li>
