              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input type="number" class="form-control @error('year') is-invalid @enderror"
                    id="year" name="year" min="2026" value="{{ old('year', $calendar->year ?? '') }}"
                    placeholder="Ex: 2026">
                  @error('year')
            ...
            <div class="border-start border-success border-4 ps-3 mb-4">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control @error('inscription_end') is-invalid @enderror"
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control @error('exam_date') is-invalid @enderror"
                    id="exam_date" name="exam_date" value="{{ old('exam_date', \Carbon\Carbon::parse($calendar->exam_date)->format('Y-m-d') ?? '') }}">
                  @error('exam_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
