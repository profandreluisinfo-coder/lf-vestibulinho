@if (!$calendar?->hasInscriptionStarted())
    <div class="calendar-container">
        ...
        <div
            class="calendar-event {{ !$calendar->hasInscriptionStarted() ? 'event-inactive' : ($calendar->isInscriptionOpen() ? 'event-active' : 'event-completed') }}">
        ...
        <div
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
                    ...
                    <p class="mb-0">Período para o(a)s candidato(a)s Portadores de Necessidades Especiais enviarem
                        e-mail com atestado médico.</p>
                </div>
                <div class="d-flex flex-column align-items-end">
                    <span class="badge {{ $calendar->isInscriptionOpen() ? 'bg-success' : 'bg-secondary' }} mb-2">
                        {{ Carbon\Carbon::parse($calendar->inscription_start)->format('d/m') }} -
        ...
        <div
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
                    ...
                    <p class="mb-0">Período para o(a) candidato(a) portador de baixa visão informar via e-mail que
                        necessita de prova ampliada e qual o tamanho da letra que precisa para realizar a prova.</p>
                </div>
                <div class="d-flex flex-column align-items-end">
                    <span class="badge {{ $calendar->isInscriptionOpen() ? 'bg-success' : 'bg-secondary' }} mb-2">
                        {{ Carbon\Carbon::parse($calendar->inscription_start)->format('d/m') }} -
        ...
        <div
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
                    ...
                    <p class="mb-0">Período para o(a)s candidatos(a)s que desejam enviar autorização dos responsáveis
                        para utilização do Nome Social</p>
                </div>
                <div class="d-flex flex-column align-items-end">
                    <span class="badge {{ $calendar->isInscriptionOpen() ? 'bg-success' : 'bg-secondary' }} mb-2">
                        {{ Carbon\Carbon::parse($calendar->inscription_start)->format('d/m') }} -
        ...
        <div
            class="calendar-event {{ !$calendar->hasInscriptionEnded() ? 'event-inactive' : ($settings->location ? 'event-completed' : 'event-active') }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
        ...
        <div
            class="calendar-event {{ !$calendar->hasInscriptionEnded() ? 'event-inactive' : ($calendar->hasExamDatePassed() ? 'event-completed' : 'event-active') }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
        ...
        <div
            class="calendar-event {{ !$calendar->hasExamDatePassed() ? 'event-inactive' : ($calendar->isAnswerKeyPublished() ? 'event-completed' : 'event-active') }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
        ...
        <div
            class="calendar-event {{ !$calendar->isAnswerKeyPublished() ? 'event-inactive' : ($calendar->isRevisionPeriodOpen() ? 'event-active' : ($calendar->hasRevisionPeriodEnded() ? 'event-completed' : 'event-active')) }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
        ...
        {{-- Resultado Final --}}
        <div
            class="calendar-event {{ !$calendar->hasRevisionPeriodEnded() ? 'event-inactive' : ($calendar->isFinalResultPublished() ? 'event-completed' : 'event-active') }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
        ...
        <div
            class="calendar-event {{ !$calendar->isFinalResultPublished() ? 'event-inactive' : ($calendar->isEnrollmentPeriodOpen() ? 'event-active' : 'event-completed') }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
                    <h5 class="mb-1">Divulgação do Chamamento (1ª Chamada)</h5>
                    <p class="mb-0">Divulgação do cronograma da convocação para matrícula dos classificados em
                        primeira chamada</p>
                </div>
                <div class="d-flex flex-column align-items-end">
        ...
        <div
            class="calendar-event {{ !$calendar->isEnrollmentPeriodOpen() ? 'event-inactive' : ($calendar->hasEnrollmentPeriodEnded() ? 'event-completed' : 'event-active') }}">
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1">
                ...
                <div class="d-flex flex-column align-items-end">
                    <span
                        class="badge {{ $calendar->hasEnrollmentPeriodEnded() ? 'bg-secondary' : 'bg-primary' }} mb-2">
