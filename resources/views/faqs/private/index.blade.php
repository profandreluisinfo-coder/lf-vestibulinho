                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    @can('manage-faq', $faq)
                                        <form id="publish-faq-form-{{ $faq->id }}"
                                            action="{{ route('faq.admin.publish', $faq->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('PUT')
                                        </form>
                                        <button type="button"
                                        ...
                                        {{-- Botão de editar --}}
                                        <a href="{{ route('faq.admin.edit', $faq->id) }}" class="btn btn-sm btn-primary">
                                            <i class="bi bi-pencil-square" title="Editar"></i>
                                        </a>

                                        {{-- Botão de excluir --}}
                                        <form id="delete-faq-form-{{ $faq->id }}"
                                            action="{{ route('faq.admin.destroy', $faq->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                    ...
                    <div class="modal-body">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <form action="{{ route('faq.admin.store') }}" method="POST" id="faqForm">
                                    @csrf
