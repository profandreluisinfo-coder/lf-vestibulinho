                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <p class="text-muted text-center">
                                    Para participar do Vestibulinho LF {{ $calendar->year }}, você precisa registrar e validar seus dados de acesso, preenchendo o formulário abaixo. Você receberá um e-mail contendo um <i>link</i>, o qual devererá ser clicado, para confirmar o endereço de e-mail cadastrado. Sem esta ação, não será possível participar do Vestibulinho.
                                </p>
                            </div>
                            <form id="form-register" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="registerEmail" value="{{ old('email') }}">
                                @error('email')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password_confirmation" id="registerRepeatPassword" class="form-control @error('password_confirmation') is-invalid @enderror">
                                ...
                                <div class="form-check mb-3">
                                    <input type="checkbox" name="terms" class="form-check-input @error('terms') is-invalid @enderror" id="agreeTerms">
                                    <label class="form-check-label" for="agreeTerms">Li e concordo com os termos do <a href="#" class="text-decoration-none" target='_blank'>edital</a></label>
                                @error('terms')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
