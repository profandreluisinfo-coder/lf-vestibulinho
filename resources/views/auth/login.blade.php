...
<body>
        ...
        <main class="panel-right">
            ...
            <div class="form-card">
                ...
                <form method="POST" action="{{ route('login') }}"
                    ...
                    <!-- Botão entrar -->
                    {{-- <button class="btn-login" type="button" onclick="doLogin(this)">
    ...
    //         style="width:.95rem;height:.95rem;border-width:2px;"></span> Verificando...`;
        //     btn.style.pointerEvents = 'none';

        //     // Simula chamada ao servidor
        //     setTimeout(() => {
        //       // Para demonstração: qualquer e-mail/senha válidos são aceitos
        //     //   document.getElementById('successOverlay').classList.add('show');
        //       // Em produção: 
        //       btn.innerHTML = originalHTML; 
        //       btn.style.pointerEvents = '';
        //       // e tratar erros do servidor com showError(...)
        //     }, 1700);
        //   }
