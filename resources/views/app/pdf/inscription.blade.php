...
<head>
    <meta charset="UTF-8">
    <title>
        {{ config('app.name') . ' ' . $calendar?->year . ' | Ficha de Inscrição'}}
    </title>
        ...
        <div class="card-body">
            ...
            <table class="table no-break">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>Documento</th>
                        <td>{{ $user->user_detail->doc_type }} - Nº {{ $user->user_detail->doc_number }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table no-break">
                ...
                <tbody>
                    ...
                    @if ($user->user_detail->certificate)
                        <tr>
                            <th>Nº Certidão</th>
            ...
            <table class="table no-break">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>Cidade/Estado</th>
                        <td>{{ $user->user_detail->city }}/{{ $user->user_detail->state }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table no-break">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>Localização</th>
                        <td>{{ $user->user_detail->school_city }}/{{ $user->user_detail->school_state }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->user_detail->mother }}
                            @if ($user->user_detail->mother_phone)
                                | Telefone: {{ $user->user_detail->mother_phone }}
                            @endif
                        </td>
                    </tr>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->user_detail->father }}
                                @if ($user->user_detail->father_phone)
                                    | Telefone: {{ $user->user_detail->father_phone }}
                                @endif
                            </td>
                        </tr>
                    @endif
                        ...
                        <tr>
                            ...
                            <td>{{ $user->user_detail->degree }}
                                @if ($user->user_detail->kinship)
                                    ({{ $user->user_detail->kinship }})
                                @endif
                                | Telefone: {{ $user->user_detail->responsible_phone }}
                            </td>
                        </tr>
                    @endif
                    <tr>
