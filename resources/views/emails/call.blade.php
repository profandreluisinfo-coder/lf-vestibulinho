  ...
  <p>Parabéns pela sua aprovação no Processo Seletivo {{ $process?->year }} da ESCOLA MUNICIPAL DR. LEANDRO
  ...
  <ol>
      <li>Declaração de Conclusão do Ensino Fundamental ou Histórico Escolar do Ensino Fundamental (Original e 01
          cópia);
      </li>
      <li>01 foto 3x4;</li>
