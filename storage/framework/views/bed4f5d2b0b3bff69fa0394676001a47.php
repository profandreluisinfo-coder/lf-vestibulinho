...
<div class="container">
    ...
    <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
        <table class="table table-striped freezed-table mb-0 caption-top">
            <caption><?php echo e(config('app.name')); ?> <?php echo e(config('app.year')); ?> - Lista de Alocação de Candidatos</caption>

            <?php if($examInfo): ?>
                <p><strong>Data da Prova:</strong> <?php echo e(\Carbon\Carbon::parse($examInfo->date)->format('d/m/Y')); ?></p>
                <p><strong>Horário:</strong> <?php echo e(\Carbon\Carbon::parse($examInfo->time)->format('H:i')); ?></p>

                <form id="location-access-form" action="<?php echo e(route('exam.access.location')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-check form-switch mb-3 mt-3">
                        <input class="form-check-input" type="checkbox" id="location" name="location"
                            onchange="confirmLocationAccess(this)" <?php echo e($accesStatus->location ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="location">
                            Acesso aos locais:
                            <span class="badge bg-<?php echo e($accesStatus->location ? 'success' : 'danger'); ?> ms-2">
                                <?php echo e($accesStatus->location ? 'Liberado' : 'Bloqueado'); ?>
                ...
                <?php if($accesStatus->location): ?>
                <div class="mt-3">
                    <a href="<?php echo e(route('system.queue.monitor')); ?>" class="text-decoration-none" target="_blank"><i class="bi bi-display animate__animated animate__fadeIn me-2"></i>Monitoramento de Fila de Envio de E-mails</a>
                </div>
                <?php endif; ?>

                <div class="mt-3">
                    <a href="<?php echo e(route('exam.list')); ?>" class="text-decoration-none" target="_blank">
                        <i class="bi bi-search animate__animated animate__fadeIn me-2"></i> Detalhes
                    </a>
                    <span class="mx-2">|</span>
                    
                    <a href="<?php echo e(route('report.exportAllocationToPdf')); ?>" target="_blank" class="text-decoration-none">
                        <i class="bi bi-file-earmark-pdf-fill animate__animated animate__fadeIn me-2"></i> Relatório para simples conferência
                    </a>
                    <span class="mx-2">|</span>
                    <a href="<?php echo e(route('report.exportRoomsToPdf')); ?>" target="_blank"
                        class="text-decoration-none">
                        <i class="bi bi-file-earmark-pdf-fill animate__animated animate__fadeIn me-2"></i> Mural e Salas
                        (PDF)
                    </a>
                    <span class="mx-2">|</span>
                    <a href="<?php echo e(route('report.exportSignaturesSheetsToPdf')); ?>" target="_blank"
                        class="text-decoration-none">
            ...
            <tbody class="table-group-divider">
                <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($room->location_name); ?></td>
                        <td><?php echo e($room->room_number); ?></td>
                        <th><?php echo e($room->qtd); ?></th>
                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="exam-schedule" method="POST" action="<?php echo e(route('exam.schedule')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="exam_date" class="form-control" id="exam_date"
                                value="<?php echo e($examDate); ?>" readonly style="background-color: #e6e6e6"
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('assets/rules/schedule.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/swa/locations/seetings.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dash.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\secretaria\resources\views/schedule/private/settings.blade.php ENDPATH**/ ?>