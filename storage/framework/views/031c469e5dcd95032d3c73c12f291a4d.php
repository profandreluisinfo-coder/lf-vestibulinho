...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title', 'Painel Administrativo - Vestibulinho LF'); ?></title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <img src="<?php echo e(asset('assets/img/logo.webp')); ?>" alt="Logo" width="32" height="32">
            <h4><?php echo e(config('app.name')); ?> <?php echo e($calendar?->year); ?></h4>
        </div>
        ...
        <nav class="sidebar-menu">
            <div class="menu-section">
                ...
                <div class="menu-item">
                    <a href="<?php echo e(route('admin.painel')); ?>" class="menu-link active">
            ...
            <div class="menu-section">
                ...
                <div class="menu-dropdown">
                    ...
                    <div class="dropdown-menu-custom" id="menuVestibulinho">
                        <a href="<?php echo e(route('calendar.index')); ?>" class="dropdown-item-custom">Calendário</a>
                        <a href="<?php echo e(route('courses.index')); ?>" class="dropdown-item-custom">Cursos</a>
                        <a href="<?php echo e(route('notice.index')); ?>" class="dropdown-item-custom">Edital</a>
                        <a href="<?php echo e(route('faq.index')); ?>" class="dropdown-item-custom">Registrar FAQ</a>
                        <a href="<?php echo e(route('archive.index')); ?>" class="dropdown-item-custom">Acervo de Provas</a>
            ...
            <div class="menu-section">
                ...
                <div class="menu-dropdown">
                    ...
                    <div class="dropdown-menu-custom" id="menuUsuarios">
                        <a href="<?php echo e(route('users.index')); ?>" class="dropdown-item-custom">Lista de Usuários</a>
                    </div>
                </div>
                ...
                <div class="menu-dropdown">
                    ...
                    <div class="dropdown-menu-custom" id="menuInscricoes">
                        <a href="<?php echo e(route('inscriptions.index')); ?>" class="dropdown-item-custom">Lista Geral</a>
                        <a href="<?php echo e(route('inscriptions.pcd')); ?>" class="dropdown-item-custom">Pessoas com
                            Deficiência</a>
                        <a href="<?php echo e(route('inscriptions.social-name')); ?>" class="dropdown-item-custom">Nome
                            Social</a>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-section">
                ...
                <div class="menu-dropdown">
                    ...
                    <div class="dropdown-menu-custom" id="menuProvas">
                        <a href="<?php echo e(route('exam.locations')); ?>" class="dropdown-item-custom">Locais</a>
                        <a href="<?php echo e(route('exam.schedule')); ?>" class="dropdown-item-custom">Agendar</a>
                        <a href="<?php echo e(route('export.users')); ?>" class="dropdown-item-custom">Planilha de Notas</a>
                    </div>
                </div>
                ...
                <div class="menu-dropdown">
                    ...
                    <div class="dropdown-menu-custom" id="menuResultados">
                        <a href="<?php echo e(route('import.results')); ?>" class="dropdown-item-custom">Importar Notas</a>
                        <a href="<?php echo e(route('ranking')); ?>" class="dropdown-item-custom">Classificação Geral</a>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-section">
                ...
                <div class="menu-item">
                    <a href="<?php echo e(route('callings.create')); ?>" class="menu-link">
            ...
            <div class="menu-section">
                ...
                <div class="menu-item">
                    <a href="<?php echo e(route('system.index')); ?>" class="menu-link">
        ...
        <div class="topbar-right">
            ...
            <div class="dropdown">
                <div class="user-menu" data-bs-toggle="dropdown">
                    ...
                    <div class="user-info">
                        <div class="user-name"><?php echo e(auth()->user()->social_name ?? auth()->user()->name); ?></div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <a href="<?php echo e(route('calendar.index')); ?>" class="offcanvas-card">
                    ...
                    <div class="col-6">
                        <a href="<?php echo e(route('users.index')); ?>" class="offcanvas-card">
                    ...
                    <div class="col-6">
                        <a href="<?php echo e(route('inscriptions.index')); ?>" class="offcanvas-card">
                    ...
                    <div class="col-6">
                        <a href="<?php echo e(route('ranking')); ?>" class="offcanvas-card">
            ...
            <div class="mb-4">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="<?php echo e(route('exam.schedule')); ?>"
                        class="list-group-item list-group-item-action border-0 px-0">
                        <i class="bi bi-calendar-check me-2"></i>Agendar Prova
                    </a>
                    <a href="<?php echo e(route('ranking')); ?>"
                        class="list-group-item list-group-item-action border-0 px-0">
                        <i class="bi bi-list-ol me-2"></i>Ver Classificação
                    </a>
                    <a href="<?php echo e(route('callings.create')); ?>"
                        class="list-group-item list-group-item-action border-0 px-0">
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                        <div>
                            ...
                            <div class="fw-bold" style="font-size: 20px; color: #1e293b;"><?php echo e($totalInscriptions); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                        <div>
                            ...
                            <div class="fw-bold" style="font-size: 20px; color: #1e293b;">
                                <?php echo e($usersWithoutInscription); ?></div>
                        </div>
    ...
    <script src="<?php echo e(asset('assets/swa/alerts-admin.js')); ?>"></script>
    ...
    <?php echo $__env->make('partials.alerts.admins', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>

</html>
<?php /**PATH C:\laragon\www\secretaria\resources\views/layouts/dash/admin.blade.php ENDPATH**/ ?>