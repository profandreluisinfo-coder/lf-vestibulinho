...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/dashboard/user/inscription.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    <div class="card border-0 shadow-sm my-5">
      <div class="card-body p-4">
              ...
              <div class="d-flex align-items-start bg-light rounded-3 p-3">
                ...
                <div>
                  ...
                  <p class="text-muted small mb-0">
                    ...
                    <?php if($notice && $notice->file && file_exists(public_path('storage/' . $notice->file))): ?>
                      <a href="<?php echo e(asset('storage/' . $notice->file)); ?>" target="_blank" class="text-decoration-none">Edital
                        <?php echo e(config('app.name')); ?>

                        <?php echo e(config('app.year')); ?></a>
                      em nosso site oficial.
                    <?php else: ?>
                      <a href="javascript:void(0);" target="_blank" class="text-decoration-none">Edital
                        <?php echo e(config('app.name')); ?>

                        <?php echo e(config('app.year')); ?>
        ...
        <div class="mb-4 text-center">
          ...
          <p class="text-muted small mb-0">
            É uma honra contar com seu interesse no <strong><?php echo e(config('app.name')); ?>

              <?php echo e(config('app.year')); ?></strong>!
          </p>
        </div>

        <div class="text-center">
          <a href="<?php echo e(route('step.personal')); ?>" class="btn btn-primary btn-lg px-5 py-3 shadow-sm">
        ...
        <div class="alert alert-danger">
            ...
            O período de inscrições para o <?php echo e(config('app.name')); ?> <?php echo e(config('app.year')); ?> foi <u>encerrado</u> em <strong><?php echo e($calendar?->inscription_end->format('d/m/Y')); ?></strong>.
            </p>
        </div>
...
<?php echo $__env->make('layouts.dash.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\secretaria\resources\views/dashboard/inscription.blade.php ENDPATH**/ ?>