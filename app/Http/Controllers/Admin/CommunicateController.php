...
class CommunicateController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('admin.communicates.index', compact('comunicados'));
    }
    ...
    {
        return view('admin.communicates.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.communicates.index')
    ...
    public function edit(Communicate $communicate): View
    {
        ...
        return view('admin.communicates.edit', compact('communicate'));
    }
