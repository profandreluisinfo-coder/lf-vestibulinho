...
class SelectionProcessController extends Controller
{
    ...
    {
        return view('admin.selection-process.edit');
    }
        ...
        try {
            ...
            */
            ...
            DB::transaction(function () use (
                ...
                */
                $oldEditalPath = $selectionProcess?->edital;
                ...
                if ($selectionProcess) {
                    ...
                    $selectionProcess = SelectionProcess::create([
                        'year' => $validated['year'],
                        'edital' => $newEditalPath,
                    ]);
                }
                ...
                */
                $event = $selectionProcess->latestEvent;

                if ($event) {
                    $event->update($eventData);
                } else {
                    $selectionProcess->events()->create($eventData);
                }
    ...
    {       
        return view('admin.selection-process.show');
    }

    public function activate(SelectionProcess $sp)
    {
